...
class WasmSandboxHandler {
    ...
    static let wasmDownloadURL = "https://github.com/flutterclaw/flutterclaw/releases/download/ios-sandbox/v3.21.0-1/alpine-ios-sandbox.initialized.wasm"
    static let wasmSHA256 = ""          // fill in after first CI build
