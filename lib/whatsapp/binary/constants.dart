/// WABinary protocol constants — token dictionaries and tag values.
/// Port of Baileys WABinary/constants.ts.
library;

/// Binary protocol tag constants.
abstract final class Tags {
  static const listEmpty = 0;
  static const dictionary0 = 236;
  static const dictionary1 = 237;
  static const dictionary2 = 238;
  static const dictionary3 = 239;
  static const interopJid = 245;
  static const fbJid = 246;
  static const adJid = 247;
  static const list8 = 248;
  static const list16 = 249;
  static const jidPair = 250;
  static const hex8 = 251;
  static const binary8 = 252;
  static const binary20 = 253;
  static const binary32 = 254;
  static const nibble8 = 255;
  static const packedMax = 127;
}

/// Single-byte string tokens (index 0-235).
...
/// Double-byte string tokens (4 dictionaries of 256 tokens each).
const doubleByteTokens = <List<String>>[
  // Dictionary 0
  <String>[
    'read-self',
    'active',
...
/// Token lookup map: string → {dict (null for single-byte), index}.
final Map<String, ({int? dict, int index})> tokenMap = _buildTokenMap();

Map<String, ({int? dict, int index})> _buildTokenMap() {
  final map = <String, ({int? dict, int index})>{};
  for (var i = 0; i < singleByteTokens.length; i++) {
    map[singleByteTokens[i]] = (dict: null, index: i);
  }
  for (var i = 0; i < doubleByteTokens.length; i++) {
    final dict = doubleByteTokens[i];
    for (var j = 0; j < dict.length; j++) {
      map[dict[j]] = (dict: i, index: j);
    }
  }
  return map;
}
